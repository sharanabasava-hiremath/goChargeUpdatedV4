    ...
    <div class="jumbotron" style="margin-top:-30px;">
        <div class="row circleStats" style="margin-top:-15px;" >
			...
			<div class="col-md-6" style="float:left">
                    <button class="btn btn-success btn-sm" style="margin-top:-38px;float:left;" data-title="add"
                            onclick="addSlot()"><i class="fa fa-plus-circle"></i>&nbsp;Create Charging Station
                    </button>
                </div>
